...
public class MineToolsAuthenticationProvider implements AuthenticationProvider {

    private static final String URL = "https://api.minetools.eu/uuid/%s";
    ...
    public CompletableFuture<ProfileResponse> requestProfile(final String username) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                if (jsonObject.has(STATUS_FIELD)) {
                    final String status = jsonObject.get(STATUS_FIELD).getAsString();
